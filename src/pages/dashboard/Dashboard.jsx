...
const Dashboard = () => {
    ...
    // Convert total sales to rupees
    const totalSalesInRupees = (data?.totalSales * conversionRate).toFixed(2);
        ...
        <>
            <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                <div className="flex items-center p-8 bg-white shadow rounded-lg">
                    ...
                    <div>
                        <span className="block text-2xl font-bold">₹{totalSalesInRupees}</span>
